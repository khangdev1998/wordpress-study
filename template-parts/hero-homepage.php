<!-- ======= Hero Section ======= -->
<section style="background-image: url(<?php echo MYTHEME_IMG_DIR ?>/hero-bg.png)" id="hero"
  ...
  <div class="container">
    <div class="row gy-4 d-flex justify-content-between">
      ...
      <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
        <img src="<?php echo MYTHEME_IMG_DIR?>/hero-img.svg" class="img-fluid mb-3 mb-lg-0" alt="">
      </div>
